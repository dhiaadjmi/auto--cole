...
export class SeequestionComponent {
  ...
  allQuestions: any[] = [
    {
      questionId: 1,
      questionText: 'Quelle est la signification du feu  affichant une lumière jaune ?',
      options: [
    ...
    {
      questionId: 2,
      questionText: 'Quelle est la signification du panneau triangulaire  ? ',
      options: [
    ...
    {
      questionId: 3,
      questionText: 'Quelle est la signification du panneau rond avec un bord rouge ?',
      options: [
    ...
    {
      questionId: 4,
      questionText: 'Quelle est la signification du panneau triangulaire avec un bord blanc?',
      options: [
